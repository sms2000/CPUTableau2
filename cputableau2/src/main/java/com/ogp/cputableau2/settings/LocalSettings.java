package com.ogp.cputableau2.settings;
...
public class LocalSettings {
    ...
    private static final String ROOT_OBTAINED = "RootObtained";
...
// Defaults
    ...
    private static void readFromPersistantStorage() {
        SharedPreferences pref = appContext.getSharedPreferences(PERSISTANT_STORAGE, Context.MODE_PRIVATE);
    ...
    public static void setExtensiveDebug(boolean value) {
        extensiveDebug = value;
    }
    ...
    public static void setPWL(boolean value) {
        usePWL = value;
    }
    ...
    public static void setBTSL(boolean value) {
        useBTSL = value;
    }
    ...
    public static void setFahrenheit(boolean value) {
        useFaherenheit = value;
    }
    ...
    public static void setRefreshMs(int value) {
        refreshMs = value;
    }
    ...
    public static void setClickTimeMs(int value) {
        clickTimeMs = value;
    }
    ...
    public static void setLongPressTimeMs(int value) {
        longPressMs = value;
    }
    ...
    public static void setTapRadiusPercent(int value) {
        tapRadiusPercent = value;
    }
    ...
    public static void setChargeCurrent(boolean value) {
        showChargeCurrent = value;
    }

    public static boolean isRootObtained() {
        SharedPreferences pref = appContext.getSharedPreferences(PERSISTANT_STORAGE, Context.MODE_PRIVATE);
        return pref.getBoolean(ROOT_OBTAINED, false);
    }

    public static void rootObtained() {
        SharedPreferences pref = appContext.getSharedPreferences(PERSISTANT_STORAGE, Context.MODE_PRIVATE);
        Editor editor = pref.edit();
        editor.putBoolean(ROOT_OBTAINED, true);
        editor.apply();
    }

    // Not preserved (local state)
    public static void setActivityRun(boolean value) {
        activityRun = value;
    }
