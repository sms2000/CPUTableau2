...
import com.ogp.cputableau2.providers.BatteryTemperatureProvider;
import com.ogp.cputableau2.providers.CPUClockProvider;
import com.ogp.cputableau2.providers.CPUCoresProvider;
import com.ogp.cputableau2.providers.CPUTemperatureProvider;
import com.ogp.cputableau2.providers.ChargingProvider;
import com.ogp.cputableau2.providers.HWProvider;
...
public class TransparentContent extends TransparentBase {
    ...
    private static final String TXT_LONG_STRING = "199.9ºF/199.9ºF_";
    ...
    private TransparentContentInterface transparentFrame;
    ...
    private Point contentSize = new Point(160, 60);
    private HWProvider providers[] = new HWProvider[MAX_PROVIDERS];


    private enum EUpdated {SAME, UPDATED, SIZE_CHANGED}
    ...
    public TransparentContent(Context context, TransparentContentInterface transparentFrame) {
        super(context);
        ...
        providers[0] = new CPUTemperatureProvider();
        providers[1] = new BatteryTemperatureProvider(context);
        providers[2] = new CPUClockProvider();
        providers[3] = new CPUCoresProvider();
        providers[4] = new ChargingProvider();
    ...
    public void init(RootCaller.RootExecutor rootExecutor) {
        for (HWProvider provider : providers) {
            provider.init(rootExecutor);
        }
    }


    public void clear() {
        Log.v(TAG, "clear. Entry...");
...
// Update		
        ...
        canvas.drawColor(BACKGROUND_COLOR | (LocalSettings.getTransparency() << 24));
    ...
    public void updateFontSize() {
        ...
        overlayPaint[0].setTextSize(LocalSettings.getFontSize());
        overlayPaint[1].setTextSize(LocalSettings.getFontSize());
        overlayPaint[2].setTextSize(LocalSettings.getFontSize());
...
// Compare new vs old
    ...
    private boolean compStrings(String v1, String v2) {
        return (null == v1) != (null == v2) || null != v1 && !v1.equals(v2);
    }
}
